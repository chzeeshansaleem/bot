...
def main():
    ...
    page_url = "https://blsitalypakistan.com/bls_appmnt/bls-italy-appointment/M2hnQXl3Mjc4NDEzMDMwNjU/NzNJT3FtQTQ3NjQ3MTA5NjIy/MVVsSldHNTQxMTI3MDU4OTA"
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if recaptcha_response is not None:
                ...
                page.wait_for_selector('textarea.g-recaptcha-response', timeout=60000)

                # Fill in the form
                page.fill('input[placeholder="Enter Email"]', 'chzeeshan1322@gmail.com')
                page.fill('input[placeholder="Enter Password"]', 'gjgne2$s@!3$b2R')
                page.evaluate(f'''() => {{
                    document.querySelector('textarea.g-recaptcha-response').value = "{recaptcha_response}";
                }}''')
                ...
                # Solve the second CAPTCHA using TrueCaptcha
                ...
                if captcha_solution is not None:
                    ...
                    if available_date:
                        ...
                        page.fill('input[name="valApplicant[1][first_name]"]', 'zeeshna')
